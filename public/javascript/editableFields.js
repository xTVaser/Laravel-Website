function clickEdit(commentId, commentBody) {
         ...
         $("#comment"+commentId).append("<input type=\"submit\" name=\"edit_comment\" value=\"Submit Edit\" class=\"btn btn-warning\">");
...
function clickReply(commentId, originalAuthor) {
        ...
        $("#comment"+commentId).append("<input type=\"submit\" name=\"reply_comment\" value=\"Submit Reply\" class=\"btn btn-info\">")
}
